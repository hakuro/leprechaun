...
Two middleware functions are provided by default in the `leprechaun.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `leprechaun.handler` namespace to manage the enabled middleware.
